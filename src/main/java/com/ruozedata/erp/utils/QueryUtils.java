...
import static com.ruozedata.erp.utils.Constants.CURRENT_PAGE;
import static com.ruozedata.erp.utils.Constants.PAGE_SIZE;
...
public class QueryUtils {
    ...
    public static int currentPage(Map<String, String> map) {
        int val = Integer.parseInt(map.get(Constants.CURRENT_PAGE));
        if (val < 1)
