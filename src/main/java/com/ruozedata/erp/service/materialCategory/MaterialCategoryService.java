package com.ruozedata.erp.service.materialCategory;
...
import com.ruozedata.erp.datasource.mappers.MaterialCategoryMapper;
import com.ruozedata.erp.datasource.mappers.MaterialCategoryMapperEx;
...
public class MaterialCategoryService {
     ...
     * @Param:
     * @return java.util.List<com.ruozedata.erp.datasource.vo.TreeNode>
     */
    ...
    public int batchDeleteMaterialCategoryByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、产品表	ruozedata_material
         * 2、产品类型表	ruozedata_materialcategory
         * 是否有相关数据
         * */
        int deleteTotal=0;
        ...
        /**
         * 校验产品类型表	ruozedata_materialcategory
         * */
