package com.ruozedata.erp.service.depot;
...
import com.ruozedata.erp.datasource.mappers.*;
...
import com.ruozedata.erp.datasource.mappers.DepotMapper;
import com.ruozedata.erp.datasource.mappers.DepotMapperEx;
import com.ruozedata.erp.exception.BusinessRunTimeException;
import com.ruozedata.erp.exception.JshException;
...
public class DepotService {
    ...
    public int batchDeleteDepotByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、单据主表	ruozedata_depothead
         * 2、单据子表	ruozedata_depotitem
         * 是否有相关数据
         * */
        int deleteTotal=0;
