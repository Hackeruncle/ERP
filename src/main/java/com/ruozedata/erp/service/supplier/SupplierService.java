package com.ruozedata.erp.service.supplier;
...
import com.ruozedata.erp.datasource.mappers.AccountHeadMapperEx;
import com.ruozedata.erp.datasource.mappers.DepotHeadMapperEx;
import com.ruozedata.erp.datasource.mappers.SupplierMapper;
import com.ruozedata.erp.datasource.mappers.SupplierMapperEx;
import com.ruozedata.erp.exception.BusinessRunTimeException;
import com.ruozedata.erp.exception.JshException;
import com.ruozedata.erp.service.accountHead.AccountHeadService;
...
public class SupplierService {
    ...
    public int batchDeleteSupplierByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、财务主表	ruozedata_accounthead
         * 2、单据主表	ruozedata_depothead
         * 是否有相关数据
         * */
        int deleteTotal=0;
