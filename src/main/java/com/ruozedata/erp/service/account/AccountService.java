package com.ruozedata.erp.service.account;
...
import com.ruozedata.erp.datasource.vo.AccountVo4InOutList;
import com.ruozedata.erp.datasource.vo.AccountVo4List;
...
public class AccountService {
    ...
    public int batchDeleteAccountByIdsNormal(String ids) throws Exception{
         ...
         * 2、财务子表	ruozedata_accountitem
         * 3、单据主表	ruozedata_depothead
         * 是否有相关数据
         * */
        int deleteTotal=0;
